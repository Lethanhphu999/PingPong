...
/*
Khởi tạo trạng thái trò chơi của ứng dụng 
*/
...
/*
Update trạng thái của trò chơi 
Cập nhập trạng thái va đập của ball 
Cập nhập thắng thua của trò chơi
*/
void PlayState::Update() {
	...
	if (!m_Victory) {  // nếu không có bên nào thắng
		...
		if (Input::Keydown(SDL_SCANCODE_RETURN)) { // sẽ đợi đến khi nhận được sự kiện nhấn phím 

			m_Ball.Reset(); //Reset bóng
		...
		if (Input::Keydown(SDL_SCANCODE_ESCAPE)) { //Nếu nhấn phím esc thì thoát chương trình 
